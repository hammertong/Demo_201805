...
//var rtc_configuration = {iceServers: [{urls: "stun:127.0.0.1:3478"},
...
function websocketServerConnect() {
    ...
    //var ws_url = 'wss://' + ws_server + '/wss';
    var ws_url = 'wss://' + ws_server + ':8443';
...
function createCall(msg) {
    ...
    console.log("skipping local media ...!");
...
function startCamera(rtspSource) {
    if (ws_conn == null) {
